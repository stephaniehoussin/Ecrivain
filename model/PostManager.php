...
class PostManager extends Manager
{
  ...
  {
      $posts = [];
      $req = $this->db()->query('SELECT id,author,title,content,DATE_FORMAT(creation_date,\'%d/%m/%Y à %Hh%i\')
                                 AS creation_date
                                 FROM posts
                                 ORDER BY id
                                 DESC');
  ...
  {
    $req = $this->db()->prepare('SELECT id,author,title,content,DATE_FORMAT(creation_date,\'%d/%m/%Y à %Hh%i\')
                                 AS creation_date
                                 FROM posts
                                 WHERE id='.$postId);
  ...
  {
      $req = $this->db()->prepare('INSERT INTO posts(author,title,content,creation_date)
